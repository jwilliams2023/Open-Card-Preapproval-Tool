...
df = pd.read_csv('extracted_data_with_llm.csv')
...
df.to_csv('extracted_data_with_llm_v2.csv', index=False)
...
print("Updated dataset saved to extracted_data_with_llm_v2.csv")
